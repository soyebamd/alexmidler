...
get_header(); ?>
 ...
 <h2>The Latest Videos</h2> <div class="viweAll"><a href="<?php echo esc_url( home_url( '/' ) ); ?>videos/">View All</a></div></div>
           <div class="postMainRow"><?php  
			$args = array( 'post_type' => 'videos', 'posts_per_page' => 4 );
			$loop = new WP_Query( $args );
			while ( $loop->have_posts() ) : $loop->the_post(); ?>
			<div class="mainContent">
           <?php $video =  explode('=',get_field('youtube_url'));
							$video_count = count($video)-1;
							/*echo $video_count;
							echo $video[$video_count];*/
							?>

              <iframe width="265" height="143" src="<?php the_field('youtube_url'); ?>?rel=0&showinfo=0" rel="0" showinfo="0" frameborder="0" allowfullscreen></iframe>
